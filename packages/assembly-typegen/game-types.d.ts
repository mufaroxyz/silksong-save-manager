export interface PlayerData {
    ...
    disableSaveQuit: boolean;
    disableSilkAbilities: boolean;
    ...
    nextScene: string;
    nonLethalRespawnMarker: string;
    nonLethalRespawnScene: string;
    nonLethalRespawnType: number;
    ...
    scenesEncounteredBench: any;
    scenesEncounteredCocoon: any;
    scenesMapped: any;
    scenesVisited: any;
    ...
    TempGeoStore: number;
    tempRespawnMarker: string;
    tempRespawnScene: string;
    tempRespawnType: number;
    ...
    UnlockSilkFinalCutscene: boolean;
